...
abstract class ProgressCircleIndicator extends Control {
    ...
    public ProgressCircleIndicator() {
        this.getStylesheets().add(getClass().getResource("/circleprogress.css").toExternalForm());
    }
    ...
    /**
     * Set the value for the progress, it cannot be more than 100 (meaning 100%). A negative value means indeterminate progress.
     * 
     * @param progressValue
